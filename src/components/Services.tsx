        ...
        <section className="services relative" id="services">
          ...
          <div className="myServicesList">
            <div className="accounting flex my-service w-11/12 bg-white">
              ...
              <div className="inside-my-service w-4/6 px-16 pt-8">
                ...
                <p className="button roboto-font pt-8 text-blue-dark float-right">
                  <a href="http://tbaccounting.rrgroup.co.nz/" target="_blank" rel="noreferrer">
                    Learn More...
                  </a>
                </p>
              </div>
            ...
            <div className="accounting flex my-service w-11/12 bg-white">
              ...
              <div>
                <img alt="switchboard" src="https://img.freepik.com/free-photo/male-electrician-works-switchboard-with-electrical-connecting-cable_169016-15204.jpg?t=st=1734380330~exp=1734383930~hmac=49680600b8fd51ba64609a6c1e85de2e55e8711a53f9b7c9ab86bdde91820f6a&w=1380" />
              </div>
            </div>

            <div className="accounting flex my-service w-11/12 bg-white">
              <img alt="cleaning" src="https://img.freepik.com/free-photo/full-shot-men-cleaning-office_23-2149345516.jpg?t=st=1732918083~exp=1732921683~hmac=b8aa26d9da482a66e0ac45d8b327dcc28ef1ef7e2aff96c99fd5de996bc29eab&w=1380" />
              <div className="inside-my-service w-4/6 px-16 pt-8">
                <h3 className="oswald-font text-blue-dark text-base uppercase tracking-wide">
                  Cleaning
                </h3>
